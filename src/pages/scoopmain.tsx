  ...
  return (
    <div className="mx-auto ">
      ...
      <div className="md:hidden">
        <div className="w-11/12 mx-auto text-lg font-bold mt-10 sm:hidden md:hidden ">스쿱 에디터's 추천</div>
      ...
      <div className="hidden md:grid md:grid-cols-12 gap-5">
        ...
        <div className="text-2xl font-bold mt-8 col-span-4">
          <div className="mt-10 md:text-3xl lg:text-4xl">나에게 맞는 웹툰을</div>
          <div className="md:text-3xl lg:text-4xl mt-3">AI가 추천해드려요.</div>
          <div className="md:text-base lg:text-xl text-gray-700 mt-12 ">'오늘은 뭐보지?' '볼 게 없네.'라고 생각했던 분들에게</div>
          <div className="md:text-base lg:text-xl text-gray-700  "> 스쿱하우스가 찾아드립니다.</div>
        ...
        <div className="col-span-2"></div>
        <div className="col-span-10 text-2xl font-bold hidden md:inline-block">스쿱 에디터's 추천</div>
        <div className="col-span-2"></div>
        <div className="mb-10 col-span-8 grid grid-cols-5 gap-4">
          <ScoopWebtoonCard webtoon={webtoon} />
          <ScoopWebtoonCard webtoon={webtoon} />
          <ScoopWebtoonCard webtoon={webtoon} />
          <ScoopWebtoonCard webtoon={webtoon} />
        ...
        <div className="col-span-2"></div>
        <div className="col-span-10 text-2xl font-bold hidden md:inline-block">웹툰 작가가 궁금해요</div>
        <div className="col-span-2"></div>
      ...
      <div className="hidden md:grid">
        <div className="w-8/12 mx-auto text-2xl font-bold mt-10">뉴스레터 받기</div>
        <div className="w-8/12 mx-auto text-xs text-gray-800 mt-3">매주 1회 에디터가 엄선한 웹툰, 웹소설을 이메일로 보내드려요.</div>
        <form className="" onSubmit={handleSubmit(onSubmit, inValid)}>
        ...
        <div className="w-8/12 mx-auto text-2xl font-bold mt-20 mb-5">이번 주에 추천된 작품이에요</div>
        <div className="w-8/12 mx-auto grid grid-cols-5 gap-4">
          <ScoopWebtoonCard webtoon={webtoon} />
          <ScoopWebtoonCard webtoon={webtoon} />
          <ScoopWebtoonCard webtoon={webtoon} />
          <ScoopWebtoonCard webtoon={webtoon} />
        ...
        <div className="w-8/12 mx-auto text-2xl font-bold mt-20">웹툰 작가 유튜부 모음</div>
        <div className="mb-10 w-8/12 mx-auto mt-3 grid grid-cols-4 gap-4">
        ...
        <div className="w-8/12 mx-auto text-2xl font-bold mt-20 mb-5">AI가 제멋대로 추천해봐요</div>
        <div className="w-8/12 mx-auto grid grid-cols-5 gap-4">
          <ScoopWebtoonCard webtoon={webtoon} />
          <ScoopWebtoonCard webtoon={webtoon} />
          <ScoopWebtoonCard webtoon={webtoon} />
        ...
        <div className="w-8/12 mx-auto text-2xl font-bold mt-10">스쿠퍼가 되고 싶나요?</div>
        <div className="w-8/12 mx-auto text-lg text-gray-800 mt-2 ">웹툰을 추천하는 스쿠퍼가 되면 리워드를 드립니다.</div>
        <div className="w-8/12 rounded-3xl bg-red-500 p-3 mt-5 mb-24 text-center text-white mx-auto "><Link to={'/recommend'}>스쿠퍼 신청하기</Link></div>
