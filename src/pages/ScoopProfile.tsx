  ...
  return (
    <div className="mx-auto sm:px-8">
      ...
      <div className="hidden md:grid">
        <div className="w-8/12 mx-auto grid grid-cols-12 mt-3">
          <div className="col-span-11">
            <div className="grid ju text-lg font-bold">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
              봉봉
            </div>
          </div>
        ...
        <div className="font-bold mx-auto text-2xl w-8/12 mt-12">내가 본 웹툰</div>
        <div className="w-8/12 mx-auto grid grid-cols-4 gap-16 mt-2">
          <div className="py-4 px-3 border rounded-xl bg-green-400">
            네이버 웹툰
            <div className="font-bold text-2xl">37개</div>
          </div>
          <div className="py-4 px-3 border rounded-xl bg-yellow-400">
            카카오 웹툰
            <div className="font-bold text-2xl">27개</div>
          </div>
          <div className="py-4 px-3 border rounded-xl bg-red-400">
            탑툰
            <div className="font-bold text-2xl">3개</div>
          </div>
          <div className="py-4 px-3 border rounded-xl bg-blue-400">
            K툰
            <div className="font-bold text-2xl">67개</div>
          </div>
        </div>

        <div className="font-bold mx-auto text-2xl w-8/12 mt-12">내가 좋아하는 장르</div>
        <div className="grid mx-auto w-8/12 grid-cols-12 gap-2 text-center">
          <ScoopTagCard tag={'드라마'} />
          <ScoopTagCard tag={'스릴러'} />
          <ScoopTagCard tag={'액션'} />
          <ScoopTagCard tag={'SF'} />
        ...
        <div className="font-bold mx-auto text-2xl w-8/12 mt-12">내가 좋아하는 작가</div>
        <div className="grid mx-auto w-8/12 grid-cols-12 gap-2 text-center">
          <ScoopTagCard tag={'자까'} />
          <ScoopTagCard tag={'주호민'} />
          <ScoopTagCard tag={'김호드'} />
        ...
        <div className="font-bold mx-auto text-2xl w-8/12 mt-12">내가 찜한 웹툰</div>
        <div className="grid mx-auto w-8/12 grid-cols-5 gap-2 text-center mt-2 mb-20">
          <ScoopLikeWebtoonCard webtoon={webtoon} />
          <ScoopLikeWebtoonCard webtoon={webtoon} />
          <ScoopLikeWebtoonCard webtoon={webtoon} />
          <ScoopLikeWebtoonCard webtoon={webtoon} />
