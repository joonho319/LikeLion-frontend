...
export const Introduction = () => {
  return (
    <>
      ...
      <div className="mt-44">
        <div className="pb-16 bg-gradient-to-br from-indigo-800 lg:pb-0 lg:z-10 lg:relative">
              ...
              <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:px-0 lg:py-20 lg:max-w-none">
                <blockquote>
                  ...
                  <footer className="mt-6">
                    <p className="text-base font-medium text-white">김기현 대표</p>
                    <p className="text-base font-medium text-cyan-100">CEO at (주) 인스텝스</p>
                  </footer>
                </blockquote>
              </div>
            </div>
