  ...
  return (
    <div>
      ...
      <div className="lg:hidden">
        <ScoopSubHeader />
        <div className="lg:max-w-sm mx-auto lg:px-8 lg:hidden">
      ...
      {/* 데스크탑 */}
      <div className="hidden lg:grid mx-auto">
        <ScoopHeader title={'SCOOP'} />
        <div className="grid grid-cols-5 w-8/12 mx-auto">
          <div className=" col-span-3 bg-gray-300 rounded-2xl mt-5" style={{height:"400px"}}></div>
          <div className="col-span-2 ml-5 mt-32">
            <div className="text-4xl font-bold mt-5">스쿱(SCOOP)은?</div>
            <div className="mt-10 text-xl">스쿱은 콘텐츠를 떠 먹여 드립니다.</div>
            <div className="mt-1 text-xl">'오늘 뭐 보지?' 고민했던 여러분께 아이스크림 한 스쿱처럼 다가 갈게요.</div>
          </div>

          <div className="col-span-2 ml-5 mt-32">
            <div className="text-4xl font-bold mt-5">AI 추천</div>
            <div className="mt-10 text-xl">당신이 본 웹툰, 웹소설을 분석하여</div>
            <div className="mt-1 text-xl">AI 가 맞춤형 추천을 제공해드립니다</div>
          </div>
          <div className=" col-span-3 bg-gray-300 rounded-2xl mt-5" style={{height:"400px"}}></div>

          <div className=" col-span-3 bg-gray-300 rounded-2xl mt-5" style={{height:"400px"}}></div>
          <div className="col-span-2 ml-5 mt-32">
            <div className="text-4xl font-bold mt-5">뉴스테러</div>
            <div className="mt-10 text-xl">매주 1회 에디터가 엄선한</div>
            <div className="mt-1 text-xl">웹툰, 웹소설을 이메일로 보내드려요.</div>
          </div>

          <div className="col-span-2 ml-5 mt-32">
            <div className="text-4xl font-bold mt-5">팟빵 & 팟캐스트</div>
            <div className="mt-10 text-xl">에디터가 모이면?</div>
            <div className="mt-1 text-xl mb-20">수다 쟁이들의 웹툰 수다</div>
          </div>
          <div className=" col-span-3 bg-gray-300 rounded-2xl mt-5" style={{height:"400px"}}></div>
